...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-mode-line-theme '(all-the-icons :separator cup :separator-scale 1.0)
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (zenburn-theme yasnippet-snippets symon string-inflection spaceline-all-the-icons ruby-refactor ruby-hash-syntax rjsx-mode pippel pipenv password-generator overseer org-brain nameless monokai-theme magithub ghub+ apiwrap magit-svn lsp-ui lsp-python json-navigator hierarchy importmagic epc ctable concurrent impatient-mode helm-xref helm-rtags helm-purpose window-purpose imenu-list google-c-style flycheck-rtags evil-org evil-lion evil-goggles evil-cleverparens paredit emojify editorconfig counsel-projectile counsel swiper ivy company-rtags rtags company-lua company-lsp lsp-mode centered-cursor-mode browse-at-remote font-lock+ zone-nyan esxml yapfify yaml-mode xterm-color ws-butler winum which-key web-mode web-beautify w3m volatile-highlights vmd-mode visual-fill-column vi-tilde-fringe uuidgen use-package toc-org tide typescript-mode tagedit systemd syntactic-close spaceline powerline smeargle slim-mode shell-pop scss-mode sass-mode rvm ruby-tools ruby-test-mode rubocop rspec-mode robe reveal-in-osx-finder restart-emacs rbenv rake rainbow-mode rainbow-identifiers rainbow-delimiters pyvenv python-environment deferred pytest pyenv-mode py-isort pug-mode prodigy popwin pip-requirements persp-mode pcre2el pbcopy paradox spinner pandoc-mode ox-reveal ox-pandoc osx-trash osx-dictionary orgit org-tree-slide org-projectile org-category-capture org-present org-pomodoro org-plus-contrib org-mime org-download org-bullets org-alert alert log4e gntp open-junk-file nvm neotree multi-term move-text mocha-snippets mmm-mode minitest markdown-toc magit-gitflow magit-gh-pulls macrostep lua-mode lorem-ipsum livid-mode skewer-mode simple-httpd live-py-mode linum-relative link-hint lice launchctl kite-mini websocket keyfreq key-chord json-mode json-snatcher json-reformat js2-refactor multiple-cursors js2-mode js-doc indent-guide hydra hy-mode hungry-delete htmlize hl-todo highlight-parentheses highlight-numbers parent-mode highlight-indentation helm-themes helm-swoop helm-pydoc helm-projectile helm-mode-manager helm-make projectile helm-gitignore request helm-flx helm-descbinds helm-dash helm-css-scss helm-company helm-c-yasnippet helm-ag handoff haml-mode grunt google-translate golden-ratio gnuplot gmail-message-mode ham-mode markdown-mode html-to-markdown gitignore-mode github-search github-clone github-browse-file gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link git-gutter-fringe+ git-gutter-fringe fringe-helper git-gutter+ git-gutter gist gh marshal logito pcache ht gh-md fuzzy fontawesome focus flyspell-correct-helm flyspell-correct flymd flycheck-pos-tip flycheck-package package-lint flycheck pkg-info epl flx-ido firestarter fill-column-indicator fancy-battery eyebrowse expand-region exec-path-from-shell evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-surround evil-search-highlight-persist evil-numbers evil-nerd-commenter evil-mc evil-matchit evil-magit magit magit-popup git-commit ghub with-editor evil-lisp-state smartparens evil-indent-plus evil-iedit-state iedit evil-exchange evil-escape evil-ediff evil-args evil-anzu anzu evil goto-chg undo-tree eval-sexp-fu highlight eshell-z eshell-prompt-extras esh-help erc-yt erc-view-log erc-terminal-notifier erc-social-graph erc-image erc-hl-nicks encourage-mode emoji-cheat-sheet-plus emmet-mode elisp-slime-nav edit-server dumb-jump disaster diminish diff-hl dash-at-point darkroom cython-mode company-web web-completion-data company-tern dash-functional tern company-statistics company-quickhelp pos-tip company-flx flx company-emoji company-c-headers company-auctex company-anaconda company column-enforce-mode color-identifiers-mode coffee-mode cmake-mode clean-aindent-mode clang-format chruby bundler inf-ruby bind-map bind-key auto-yasnippet yasnippet auto-highlight-symbol auto-dim-other-buffers auto-dictionary auto-compile packed auctex anaconda-mode pythonic f dash s all-the-icons memoize aggressive-indent adaptive-wrap ace-window ace-link ace-jump-helm-line helm avy helm-core async ac-ispell auto-complete popup material-theme))))
(custom-set-faces
