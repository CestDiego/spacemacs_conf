...
(defun utils/post-init-helm ()
  ...
  (defvar helm-http-1xx-status-source
    '((name . "Informational 1xx")
      (candidates . (("100 Continue") ("101 Switching Protocols") ("102 Processing")))
      (action . message)))

  (defvar helm-http-2xx-status-source
    '((name . "Successful 2xx")
      (candidates . (("200 OK")
  ...
  (defvar helm-http-3xx-status-source
    '((name . "Redirection 3xx")
      (candidates . (("300 Multiple Choices") ("301 Moved Permanently")
                     ("302 Found") ("303 See Other")
                     ("304 Not Modified") ("305 Use Proxy")
                     ("307 Temporary Redirect")))
      (action . message)))

  (defvar helm-http-4xx-status-source
    '((name . "Client Error 4xx")
      (candidates . (("400 Bad Request")
  ...
  (defvar helm-http-5xx-status-source
    '((name . "Server Error 5xx")
      (candidates . (("500 Internal Server Error") ("501 Not Implemented")
                     ("502 Bad Gateway")
  ...
  (defun helm-httpstatus ()
    (interactive)
    (helm :sources (list helm-http-1xx-status-source
                         helm-http-2xx-status-source
                         helm-http-3xx-status-source
                         helm-http-4xx-status-source
                         helm-http-5xx-status-source)))
